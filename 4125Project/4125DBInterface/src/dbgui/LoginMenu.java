	...
	*/
	...
	private void initGUI() {
		try {
			...
			{
				usernameField = new JTextField("granck");
			...
			{
				passwdField = new JTextField("RrML3CFv");
			...
			}
			{
				...
				tabModBut.setText("Modify Tables");
	...
	private void queriesButActionPerformed(ActionEvent evt){
		//System.out.println("queriesBut.actionPerformed, event=" + evt);
