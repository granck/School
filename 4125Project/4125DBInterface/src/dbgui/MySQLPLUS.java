			...
			if (command.toUpperCase().equals("SELECT")) {
				...
				if (numRow > 0) {
					if (command.toUpperCase().equals("INSERT")) {
						message.setText(numRow + " row(s) " + command.toLowerCase() + "ed.");
					} else {
						message.setText(numRow + " row(s) " + command.toLowerCase() + "d.");
					}
				} else
					if (command.toUpperCase().equals("INSERT")) {
						message.setText("No row was " + command.toLowerCase() + "ed.");
					} else {
						message.setText("No row was " + command.toLowerCase() + "d.");
					}
			}
